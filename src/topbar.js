...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <div class="dropdown-item text-center small text-gray-500" >Show All Alerts</div>
        </div>
    </li>
    <li class="nav-item dropdown no-arrow mx-1">
        <div class="nav-link dropdown-toggle"  id="messagesDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <div class="dropdown-item text-center small text-gray-500">Read More Messages</div>
        </div>
    </li>
